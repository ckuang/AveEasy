...
var = File.read("db/addresses.txt")
...
x = 0
while x < 100
  Listing.create!(address: (Faker::Address.street_address), beds: rand(10),
  baths: rand(5), price: rand(1000000), category: listing_category[rand(3)],
  user_id: 3, lat: Faker::Address.latitude,
